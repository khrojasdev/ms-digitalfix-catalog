...
Catalogo tecnico: servicios, repuestos, stock y la relacion entre ambos.
...
- [`digitalfix-ms-catalogo`](https://github.com/khrojasdev/digitalfix-ms-catalogo) - Microservicio **(este)**
- [`digitalfix-ms-ordenes`](https://github.com/khrojasdev/digitalfix-ms-ordenes) - Microservicio
